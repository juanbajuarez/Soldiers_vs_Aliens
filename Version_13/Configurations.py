...
class Configurations:
    ...
    @classmethod
    def get_power_up_size(cls) -> tuple[int, int]:
        return cls._power_up_size
    ...
    @classmethod
    def get_power_up_speed(cls) -> int:
        return cls._power_up_speed

    @classmethod
    def get_time_power_up(cls) -> int:
        return cls._time_power_up
    @classmethod
    def get_time_in_time_power(cls) -> int:
        return cls._time_in_time_power
    ...
    @classmethod
    def get_soldier_sheet_path1(cls) -> str:
        return cls._soldier_sheet_path1
    ...
    @classmethod
    def get_power_up_image_path(cls) -> str:
        return cls._power_up_image_path
